...
class ConsultaPatrimonioSetor extends TPage 
{
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->datagrid->setGroupColumn('nm_setor', '<b>+ Setor:</b> <i>{nm_setor}</i>');

        $nm_itembem    = new TDataGridColumn('nm_itembem', 'Nome do Bem', 'left', '20%');
        $nm_grupobem   = new TDataGridColumn('nm_grupobem', 'Grupo Bem', 'left', '20%');
    ...
    public function onReload($param)
    {
        try {
            ...
            $consulta = ConsultaPatrimonioSetorService::consultaPatrimonioSetor($conn);
